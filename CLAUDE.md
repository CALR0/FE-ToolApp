...
- `main()` — construye la barra lateral (selector de perfil → `_selector_perfil`, expander **⚙️ Ajustes** con la fecha FOPAT, y los grupos de módulos como botones) y renderiza el **módulo activo** (`st.session_state["modulo_activo"]`).

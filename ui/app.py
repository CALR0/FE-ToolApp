...
class GeneradorApp:
    ...
    def _build_ui(self):
        ...
        def _show_panel(key):
            ...
            if key in ("consultar_remesas", "corregir_remesa", "anular_cumplido"):
        ...
        for key in ("generar","excel","rndc","editar","reconstruir","consultar_remesas","corregir_remesa","anular_cumplido","extraer_rg","cruzar_remesas"):
